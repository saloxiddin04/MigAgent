  ...
  return (
    <>
      ...
      <div className="app-container">
        {pathname !== "/login" && pathname !== "/register" && pathname !== "/forgot" && !pathname?.startsWith("/auth") && <Navbar/>}
        ...
        {pathname !== "/login" && pathname !== "/register" && pathname !== "/forgot" && !pathname?.startsWith("/auth") && <Footer/>}
